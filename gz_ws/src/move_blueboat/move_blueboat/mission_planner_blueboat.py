...
class CoordinateApp:
    ...
    def plan_path(self):
        ...
        complete_path_with_cost = []
        complete_path_without_cost = []
        ...
        for i in range(len(all_points) - 1):
            ...
            complete_path_with_cost.extend(segment_path_with_cost)
            complete_path_without_cost.extend(segment_path_without_cost)

        self.draw_path(complete_path_with_cost)
        self.draw_path(complete_path_without_cost, dash=(5, 2))
        self.save_path(complete_path_with_cost, "mission_path.txt")
