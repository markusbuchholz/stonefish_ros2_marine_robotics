...
#ifndef __Stonefish_Goal__
#define __Stonefish_Goal__

#include "entities/StaticEntity.h"

namespace sf
{
    //! A static Goal loaded from a file or taking one of the simple geometrical shapes.
    class Goal : public StaticEntity
    {
    public:
        //! A constructor building an Goal based on mesh files.
        /*!
        ...
        //! A constructor building an Goal based on a mesh file.
        /*!
         \param uniqueName a name for the body
         ...
         \param look the name of the graphical material used for rendering
         */
        Goal(std::string uniqueName, std::string modelFilename, Scalar scale, const Transform& origin, bool convexHull, std::string material, std::string look = "");
        
        //! A constructor building a spherical Goal.
        /*!
         \param uniqueName a name for the body
         ...
         \param look the name of the graphical material used for rendering
         */
        Goal(std::string uniqueName, Scalar sphereRadius, const Transform& origin, std::string material, std::string look = "");
    
        //! A constructor building a box Goal.
        /*!
         \param uniqueName a name for the body
         ...
         */
        Goal(std::string uniqueName, Vector3 boxDimensions, const Transform& origin, std::string material, std::string look = "", unsigned int uvMode = 0);
        
        //! A constructor building a cylindrical Goal.
        /*!
         \param uniqueName a name for the body
         ...
         \param look the name of the graphical material used for rendering
         */
        Goal(std::string uniqueName, Scalar cylinderRadius, Scalar cylinderHeight, const Transform& origin, std::string material, std::string look = "");
