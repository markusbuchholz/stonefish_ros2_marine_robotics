...
namespace sf
{
    ...
    public:
        ...
        */
        ...
        std::string CreateSegmentationLook(const std::string& name, Color color, GLfloat specular, GLfloat shininess, GLfloat reflectivity, const std::string& albedoTextureName="");
