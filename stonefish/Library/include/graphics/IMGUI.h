...
namespace sf
{
    ...
    public:
        ...
        void DrawRoundedRect2(GLfloat x, GLfloat y, GLfloat w, GLfloat h, glm::vec4 color = glm::vec4(1));
        void DrawTriangle(GLfloat x, GLfloat y, GLfloat w, GLfloat h, glm::vec4 color);
        void DrawRect2(GLfloat x, GLfloat y, GLfloat w, GLfloat h, glm::vec4 color = glm::vec4(1));
        void DrawRoundedRectAngle(GLfloat x, GLfloat y, GLfloat w, GLfloat h, glm::vec4 color, float rotationAngle);
    private:
        Uid getHot();
        Uid getActive();
