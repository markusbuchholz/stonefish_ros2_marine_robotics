...
namespace sf
{
    ...
    private:
        ...
        GLuint cameraPBO;
        GLuint cameraLogLumTex;   // Last logarithm luminance image
        GLuint cameraEventTex[3]; // Events, last event timestamps, crossings
        GLuint cameraEventCounter; // Atomic event counter
