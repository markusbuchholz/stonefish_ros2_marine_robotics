...
namespace sf
{
    ...
    enum class VisionSensorType {COLOR_CAMERA, DEPTH_CAMERA, MULTIBEAM2, FLS, SSS, MSIS, OPTICAL_FLOW_CAMERA, EVENT_BASED_CAMERA};
    ...
    public:
        ...
        //! A method returning the sensor velocity in world frame.
        /*!
         \param linear the linear part of the sensor velocity [m/s]
         \param angular the angular part of the sensor velocity [m/s]
        */
        virtual void getSensorVelocity(Vector3& linear, Vector3& angular) const;
