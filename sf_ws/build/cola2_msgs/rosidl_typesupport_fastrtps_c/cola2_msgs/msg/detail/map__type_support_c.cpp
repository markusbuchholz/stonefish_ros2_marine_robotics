...
#include "cola2_msgs/msg/detail/map__rosidl_typesupport_fastrtps_c.h"
...
#include "cola2_msgs/msg/detail/landmark__functions.h"  // landmark
...
using _Map__ros_msg_type = cola2_msgs__msg__Map;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: landmark
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cola2_msgs, msg, Landmark
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: landmark
  {
    ...
    if (ros_message->landmark.data) {
      cola2_msgs__msg__Landmark__Sequence__fini(&ros_message->landmark);
    }
...
size_t get_serialized_size_cola2_msgs__msg__Map(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Map__ros_msg_type * ros_message = static_cast<const _Map__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name landmark
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cola2_msgs__msg__Landmark(
...
static uint32_t _Map__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__Map(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__Map(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: landmark
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cola2_msgs__msg__Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__Map;
    is_plain =
      (
      offsetof(DataType, landmark) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Map__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__Map(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, Map)() {
