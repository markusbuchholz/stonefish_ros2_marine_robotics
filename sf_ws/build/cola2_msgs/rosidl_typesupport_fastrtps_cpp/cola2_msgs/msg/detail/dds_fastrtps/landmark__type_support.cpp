...
#include "cola2_msgs/msg/detail/landmark__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cola2_msgs::msg::Landmark & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: last_update
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.last_update,
    cdr);
  // Member: landmark_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::msg::Landmark & ros_message)
{
  // Member: last_update
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::Landmark;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::Landmark *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::Landmark *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_Landmark__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, Landmark)() {
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_Landmark__handle;
}
