...
class Metaclass_Map(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cola2_msgs.msg import Landmark
...
class Map(metaclass=Metaclass_Map):
    ...
    _fields_and_field_types = {
        ...
        'landmark': 'sequence<cola2_msgs/Landmark>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['cola2_msgs', 'msg'], 'Landmark')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'landmark' field must be a set or sequence and each value of type 'Landmark'"
