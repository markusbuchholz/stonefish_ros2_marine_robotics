...
ROS2GraphicalSimulationApp::ROS2GraphicalSimulationApp(std::string name, std::string dataPath, RenderSettings s, HelperSettings h, std::string td, ROS2SimulationManager* sim)
    : GraphicalSimulationApp(name, dataPath, s, h, td, sim)
{
}
